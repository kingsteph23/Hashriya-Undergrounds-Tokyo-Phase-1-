...
#Intro
choice = input("Welcome to the land of the rising sun, do you wish to begin?(yes/no)").lower().strip()
if choice.lower().strip() == "yes":
    print("IKUZO, LETS BEGIN")
else:
    print("Too bad. Welcome to the wangan sen ;)")

# Selecting a Japanese car Manufactuer.  I'll add some European cars in a future update.
JDM = input("Please select a Japanese Car Manufactuer(Honda/Mazda/Mistubushi/Nissan/Subaru/Toyota)")
if JDM == "Honda":
...
city = input(" Wonderful choice. Proceed to select a course(C1 outer/Bayshore route) ")
if city == "C1 outer":
    city = input("")
else:
